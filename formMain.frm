...
Private Sub cmdInitPayment_Click()
    ...
    sEnv = sEnv & "<xsd:request>"
        ...
        sEnv = sEnv & "<xsd:ReturnUrl>https://www.mercurypay.com</xsd:ReturnUrl>"
...
Private Sub cmdReset_Click()
    ...
    WebBrowser1.Navigate "https://googledrive.com/host/0B63R7kzx9jgEMUlxbUk5Ql9kYnM/iframeredirectURL.html"
        ...
        If found1 > 0 Then 'Found
            ...
            If found2 > found1 Then 'Found
                ...
                If txtCmdStatus.Text = 0 Then 'Good
                    WebBrowser1.Navigate "https://googledrive.com/host/0B63R7kzx9jgEMUlxbUk5Ql9kYnM/TransactionCompleteURL.html"
                    cmdVerify.Enabled = False
                End If
            End If
        End If
